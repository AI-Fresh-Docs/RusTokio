...
| `search` | admin + storefront | `in_progress` | `in_progress` | `core_transport_ui` | `crates/rustok-search/docs/implementation-plan.md` (slice #33: storefront preset chips render core-owned chip view-models; GraphQL fallback unchanged) |
