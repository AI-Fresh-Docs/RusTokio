...
| `pricing` | admin + storefront | `in_progress` | `in_progress` | `crates/rustok-pricing/docs/implementation-plan.md` (slice: storefront core request validation + transport facade tests) |
