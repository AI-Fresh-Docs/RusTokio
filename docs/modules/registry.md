...
| `search` | admin + storefront | `in_progress` | `in_progress` | `core_transport_ui` | `crates/rustok-search/docs/implementation-plan.md` (slice #36: storefront empty/feature cards render core-owned view-models; GraphQL fallback unchanged) |
