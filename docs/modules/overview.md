...
- какие обязательные core-crate входят в ядро платформы.
...
## 3. Дополнительные обязательные core-модули (вне ModuleRegistry)

Эти crate'ы тоже относятся к обязательным core-модулям платформы:
