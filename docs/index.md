...
- [Server docs](../apps/server/docs/README.md) (includes mandatory `ModuleKind::Core` module baseline for agents, plus infrastructure split notes, Loco feature matrix, auth password-reset email delivery, dev seed behavior notes, and build-request event publication wiring)
