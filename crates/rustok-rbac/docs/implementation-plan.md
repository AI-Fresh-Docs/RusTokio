...
- [x] Add module-level dual-read orchestrator (`shadow_dual_read::evaluate_dual_read`) so `apps/server` does not keep local branching for `disabled/skipped/matched/mismatch` outcomes.
